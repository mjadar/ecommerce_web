        ...
        <div class="col-md-6">
            ...
            <form id="payment-form" action="{{route('checkout.store')}}" method="POST" class="my-4">
               @csrf
                ...
                <button id="submit" class="btn btn-success mt-4">Proceder au paiement ({{getPrice(Cart::total())}})</button>
              </form>
        </div>
    </div>
</div>
...
@section('extra-js')
    <script >
        var stripe = Stripe('pk_test_51H1bE9AyvXzALkmAIysJBNdUhy1f76LANjmMU0vy2V8t9EnldIjPP8pt5w1SJWJ5khCvLm1J0cKU1eJpbf5xAHfg00wbqaIb71');
